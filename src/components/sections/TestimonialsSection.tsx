...
const PARTNERS = [
  ...
  { name: "PT INDRATAMA LOGISTICS", logo: generateLogo("PT. INDRATAMA LOGISTICS") },
  { name: "PT TRIMITRA SINERGI NUSA", logo: generateLogo("PT. TRIMITRA SINERGI NUSA") },
  { name: "PT RIANINDA UTAMA EKSPRESS", logo: generateLogo("PT. RIANINDA UTAMA EKSPRESS") },
  ...
  { name: "JAYA SAMUDRA CARGO", logo: generateLogo("JAYA SAMUDRA CARGO") },
  ...
  { name: "PT. SANTOS JAYA MAKMUR", logo: generateLogo("PT. SANTOS JAYA MAKMUR") },
];
